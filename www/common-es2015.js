...
/***/ "./src/app/services/collec-list.service.ts":
/*!*************************************************!*\
  !*** ./src/app/services/collec-list.service.ts ***!
  \*************************************************/
/*! exports provided: CollecList */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CollecList", function() { return CollecList; });
...
/* harmony import */ var _authentification_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./authentification.service */ "./src/app/services/authentification.service.ts");





let CollecList = class CollecList {
    constructor(db, authServ) {
        this.db = db;
        this.authServ = authServ;
        this.getDatabaseReloaded = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
        this.authServ.getLoggedInName.subscribe(event => { this.getDatabase(); });
        this.getDatabase();
    }
    getDatabase() {
        this.listCollection = this.db.collection('list', ref => ref.where('ownerID', '==', this.authServ.getUserID()));
        this.listWatchOnlyCollection = this.db.collection('list', ref => ref.where('readerIDS', 'array-contains', this.authServ.getUserID()));
        this.listSharedCollection = this.db.collection('list', ref => ref.where('writerIDS', 'array-contains', this.authServ.getUserID()));
        this.lists = this.listCollection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(actions => {
        ...
        this.listsWatchOnly = this.listWatchOnlyCollection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(actions => {
            return actions.map(a => {
                const data = a.payload.doc.data();
                const id = a.payload.doc.id;
                return Object.assign({ id }, data);
        ...
        this.listsShared = this.listSharedCollection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(actions => {
            return actions.map(a => {
                const data = a.payload.doc.data();
                const id = a.payload.doc.id;
                return Object.assign({ id }, data);
    ...
    getListById(id) {
        let test = this.db.collection('list', ref => ref.where('id', '==', id));
        return test.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(actions => {
            return actions.map(a => {
                const data = a.payload.doc.data();
                const id = a.payload.doc.id;
                return Object.assign({ id }, data);
...
CollecList.ctorParameters = () => [
    { type: angularfire2_firestore__WEBPACK_IMPORTED_MODULE_2__["AngularFirestore"] },
    { type: _authentification_service__WEBPACK_IMPORTED_MODULE_4__["AuthService"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])(),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"])
], CollecList.prototype, "getDatabaseReloaded", void 0);
CollecList = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
    }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [angularfire2_firestore__WEBPACK_IMPORTED_MODULE_2__["AngularFirestore"], _authentification_service__WEBPACK_IMPORTED_MODULE_4__["AuthService"]])
], CollecList);
...
let HeaderComponent = class HeaderComponent {
    constructor(authServ, router, platform, location) {
        this.authServ = authServ;
        this.router = router;
