...
var CollecList = /** @class */ (function () {
    function CollecList(db, authServ) {
        var _this = this;
        this.db = db;
        this.authServ = authServ;
        this.getDatabaseReloaded = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
        this.authServ.getLoggedInName.subscribe(function (event) { _this.getDatabase(); });
        this.getDatabase();
    }
    CollecList.prototype.getDatabase = function () {
        var _this = this;
        this.listCollection = this.db.collection('list', function (ref) { return ref.where('ownerID', '==', _this.authServ.getUserID()); });
        this.listWatchOnlyCollection = this.db.collection('list', function (ref) { return ref.where('readerIDS', 'array-contains', _this.authServ.getUserID()); });
        this.listSharedCollection = this.db.collection('list', function (ref) { return ref.where('writerIDS', 'array-contains', _this.authServ.getUserID()); });
        this.lists = this.listCollection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (actions) {
        ...
        this.listsWatchOnly = this.listWatchOnlyCollection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (actions) {
            return actions.map(function (a) {
                var data = a.payload.doc.data();
                var id = a.payload.doc.id;
                return tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({ id: id }, data);
        ...
        this.listsShared = this.listSharedCollection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (actions) {
            return actions.map(function (a) {
                var data = a.payload.doc.data();
                var id = a.payload.doc.id;
                return tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({ id: id }, data);
    ...
    CollecList.prototype.getLists = function () {
        return this.lists;
    };
    CollecList.prototype.getListsWatchOnly = function () {
        return this.listsWatchOnly;
    };
    CollecList.prototype.getListsShared = function () {
        return this.listsShared;
    };
    CollecList.prototype.addList = function (list) {
        var ret = this.listCollection.add(list);
        this.getDatabase();
        return ret;
    };
    CollecList.prototype.delete = function (list) {
        return this.listCollection.doc(list.id).delete();
    };
    CollecList.prototype.getListById = function (id) {
        var test = this.db.collection('list', function (ref) { return ref.where('id', '==', id); });
        return test.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (actions) {
            return actions.map(function (a) {
                var data = a.payload.doc.data();
                var id = a.payload.doc.id;
                return tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({ id: id }, data);
    ...
    CollecList.ctorParameters = function () { return [
